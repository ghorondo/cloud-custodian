...
from c7n.filters.vpc import VpcFilter
...
class ComprehendEndpoint(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        detail_spec = (
            'describe_endpoint', 'EndpointArn', 'EndpointArn', None)
        arn = id = 'EndpointArn'
        name = 'EndpointArn'
        date = 'CreationTime'
...
class ComprehendEntityRecognizer(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        detail_spec = (
            'describe_entity_recognizer', 'EntityRecognizerArn', 'EntityRecognizerArn', None)
...
class ComprehendDocumentClassifier(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        detail_spec = (
            'describe_document_classifier', 'DocumentClassifierArn', 'DocumentClassifierArn', None)
...
class ComprehendFlywheel(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        detail_spec = (
            'describe_flywheel', 'FlywheelArn', 'FlywheelArn', None)
        arn = id = 'FlywheelArn'
        name = 'FlywheelArn'
        date = 'CreationTime'
        permission_prefix = 'comprehend'
